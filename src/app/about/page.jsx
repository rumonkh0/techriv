...
export default function AboutPage() {
  return (
    <div>
      <section className="relative z-10 text-center max-w-3xl mx-auto pt-10 sm:pt-14 pb-16 sm:pb-25 px-4">
        {/* Gradient Heading */}
        <h2 className="text-4xl sm:text-5xl md:text-7xl font-semibold bg-[linear-gradient(90deg,#3753CB_0%,#5E5DD5_48%,#007FBB_100%)] bg-clip-text text-transparent">
          About TechRiv
        </h2>
    ...
    rounded-tl-[15px] rounded-tr-[60px] sm:rounded-tr-[120px] 
    rounded-bl-[60px] sm:rounded-bl-[120px] rounded-br-[15px]

    /* Center content vertically but keep text left-aligned */
    flex flex-col justify-center items-center text-left
  "
          >
            <ul className="space-y-4 text-gray-700 w-fit text-sm sm:text-base">
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          "
          >
            <ul className="space-y-4 text-gray-700 text-left w-fit text-sm sm:text-base">
              <li className="flex items-start gap-3">
                <span className="w-2 h-2 rounded-full bg-blue-600 mt-2"></span>
...
function CoreValues() {
  ...
  return (
    <section className="py-12 sm:py-20 bg-linear-to-b from-[#F3F7FF] to-white">
      <div className="text-center mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 sm:mb-6">
          Our Core Values
        </h2>
        <p className="text-[#535353] text-base sm:text-lg mb-8 sm:mb-13">
